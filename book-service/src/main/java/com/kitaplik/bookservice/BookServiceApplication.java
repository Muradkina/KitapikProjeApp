...
public class BookServiceApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Book book = new Book("Açlık", 1980, "Knut Hamsun", "Varlık yayınları", "777", "Pskoloji");
        Book book1 = new Book("Bilinçaltı ", 1915, "Sigmund Freud", "Yason yayınları", "5812", "Pskoloji");
