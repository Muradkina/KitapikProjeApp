...
//Controller görev:kendisine yapılan http isteğini önce secrutey varsa bunu kontrol eder
//Controller daha sonra validation eder
//Controller ilgili servise o isteği aktarır almıs oldugu servisten response(cevabı)da
// response entıtye çevirerek kullanıcya iade eder
